"""
Sphinx configuration for Eikon API documentation.
...
# the cross-references autodoc generates (e.g. `#module-eikon.config._schema`,
# `#eikon.config._schema.ProjectConfig`) actually resolve on GitHub.
