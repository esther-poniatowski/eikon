...
The function must accept a positional matplotlib `Axes` argument and keyword arguments. It matches the [`PlotFunction` protocol](../api/render.md#eikon.render._protocols.PlotFunction).
...
See [the generated extension API](../api/ext.md#module-eikon.ext._registry) for the complete API reference.
